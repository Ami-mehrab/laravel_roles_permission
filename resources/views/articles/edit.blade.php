<x-app-layout>
    ...
    <div class="max-w-3xl mx-auto mt-10">
        <div class="bg-white shadow-md rounded-lg overflow-hidden">
            ...
            <div class="p-6">
                <form action="{{Route('articles.update',$articles->id)}}" method="POST" id="articlesForm">
                    @csrf
                     @method('PUT')
                    ...
                    <div class="mb-5">
                        ...
                        <input type="text" value="{{old('title',$articles->title)}}" name="title" id="articlestitle"
                    ...
                    <div class="mb-5">
                        ...
                        <input type="text" value="{{old('author',$articles->author)}}" name="author" id=""
                            class="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
