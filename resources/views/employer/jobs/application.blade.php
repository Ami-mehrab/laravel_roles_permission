            ...
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="divide-y divide-gray-200 text-sm text-gray-800">
                    ...
                    <tr class="hover:bg-gray-50 transition">
                        <td class="px-6 py-4">{{ $applicant->pivot->applicant_name }}</td>
                        <td class="px-6 py-4">{{ $applicant->pivot->applicant_email }}</td>
                        <td class="px-6 py-4">
                            <a href="{{ asset('storage/' . $applicant->pivot->resume_path) }}" target="_blank"
